...
export default function SeoLinkHub({ excludeSlug, mode: _mode = "all" }: SeoLinkHubProps) {
      ...
      <div className="container" style={{ maxWidth: "1200px" }}>
        ...
        <div className={styles.relatedServicesGrid}>
          ...
          <div className={styles.relatedServiceCard}>
            ...
            <div className={styles.relatedServiceList} style={{ gap: "8px" }}>
              {otherAreas.map((area) => {
          ...
          <div className={styles.relatedServiceCard}>
            ...
            <div className={styles.relatedServiceList}>
              ...
              <div className={styles.callActionGroup} style={{ marginTop: "auto", paddingTop: "16px" }}>
